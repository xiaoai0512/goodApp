<template>
  ...
  <div>
    ...
    />
    <div>
      <van-tabs v-model="active" @click="onClick" sticky="sticky" offset-top="44">
        <van-tab title="审批中" name="todo">
          <div class="goods-out">
            <div v-if="inListNull" class="norecord">无记录</div>
            <div class="list" >
              <div class="left" >
                <div class="number">申请编号：</div>
                <div class="number">申请类型：</div>
                <div class="number">审批结果</div>
                <div class="number">审批完成时间</div>
                <div class="number">申请时间：</div>
                <div class="item">领取状态：</div>
              </div>
                  <div class="right">
                    <div class="round">
                      <van-button type="primary" @click="hadleDetail()">详情</van-button>
                    </div>
                  </div>
            </div>
             <div class="list" >
        ...
        <van-tab title="审批完成" name="done">
          <div class="goods-out">
            ...
            <div class="list" >
              <div class="left" >
                <div class="number">申请编号：审批完成</div>
                <div class="number">申请类型：审批完成</div>
                <div class="number">审批完成时间 审批完成</div>
                <div class="number">申请时间：审批完成</div>
                <div class="item">领取状态：审批完成</div>
              </div>
                  <div class="right">
                    <div class="round">
                      <van-button type="primary" @click="hadleDetail()">详情</van-button>
